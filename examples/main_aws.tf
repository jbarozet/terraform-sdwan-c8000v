...
module "my_vpc" {
  ...
  # source = "github.com/jbarozet/terraform-sdwan-c8000v//modules/terraform-sdwan-aws-vpc"
...
module "c8000v_aws" {
  ...
  # source = "github.com/jbarozet/terraform-sdwan-c8000v//modules/terraform-sdwan-aws-c8000v"
